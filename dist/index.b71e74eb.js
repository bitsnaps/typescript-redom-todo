...
var _adding = require("./adding");
var _addingDefault = parcelHelpers.interopDefault(_adding);
var h1 = _redom.el("h1", "Hello RE:DOM!");
var logo = _redom.el("h1", "Hello RE:DOMsddddff''fd!");
// Write TypeScript code!
const appDiv = document.getElementById("app");
//appDiv.innerHTML = h1.innerHTML;
// mount(document.body, logo);
const todo = new _addingDefault.default();
_redom.mount(appDiv, logo);
_redom.mount(appDiv, todo);
console.log("mount again");

},{"./style.css":"bhJkM","redom":"djZ75","./adding":"gHEZs","@parcel/transformer-js/src/esmodule-helpers.js":"bvnI6"}],"bhJkM":[function() {},{}],"djZ75":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"gHEZs":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _redom = require("redom");
var _todo = require("./todo");
var _todoDefault = parcelHelpers.interopDefault(_todo);
var _todoComp = require("./todoComp");
var _todoCompDefault = parcelHelpers.interopDefault(_todoComp);
class Adding {
    constructor(){
        this.el = _redom.el("form#login", this.content = _redom.el("input.text", {
            type: "text"
        }), _redom.el("button", {
            type: "submit"
        }, "+"));
        this.el.onsubmit = (e)=>{
            e.preventDefault();
            let todo = new _todoDefault.default(this.content.value);
            let comp = new _todoCompDefault.default(todo);
            _redom.mount(document.body, comp);
            console.log("running" + e);
        };
    }
}
exports.default = Adding;

},{"redom":"djZ75","./todo":"i31z9","./todoComp":"gHkeQ","@parcel/transformer-js/src/esmodule-helpers.js":"bvnI6"}],"i31z9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Todo {
    constructor(content){
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"bvnI6"}],"gHkeQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _redom = require("redom");
class TodoComp {
    constructor(content){
        this.content = content;
        this.el = _redom.el("p.todo", content.content);
    }
    getNote() {
        return this.content;
    }
...
exports.default = TodoComp;

},{"redom":"djZ75","@parcel/transformer-js/src/esmodule-helpers.js":"bvnI6"}]},["kMjup","h7u1C"], "h7u1C", "parcelRequire699c")
